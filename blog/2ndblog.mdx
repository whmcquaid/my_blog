...
<div>
  <p>
    ...
    can be to get up and running with react.
  </p>
  <p>
    {' '}
    ...
    to modularize the content, moving the data from that .tsx file into separate
    files. I had about 20-30 lines that repeated for each project so I was able to
    reduce all that down to just a few lines with a .map function.
  </p>
  <p>
    {' '}
